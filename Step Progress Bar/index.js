...
const progresEl = document.querySelector(".progress-bar-front")
...
const checkedNumber = document.querySelectorAll
 (".checked")
progresEl.style.width = ((checkedNumber.length -1) /
